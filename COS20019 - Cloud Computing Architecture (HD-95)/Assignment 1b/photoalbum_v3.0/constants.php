...
define('STUDENT_NAME', 'Khanh Toan Nguyen');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '104180605');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Wednesday 6:30PM');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'tnguyenawsbucket');
